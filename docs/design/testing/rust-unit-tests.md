...
- **Semantic evaluator.** Evaluation of expectations and logical composition (`all`/`any`/`not`) against a workspace/process state, in [`crates/reportage-core/src/semantic.rs`](../../../crates/reportage-core/src/semantic.rs) and [`crates/reportage-core/src/evaluator.rs`](../../../crates/reportage-core/src/evaluator.rs).
- **Expectation evaluator.** Checkpoint-based evaluation of individual expectations (exit, stdout/stderr, file/dir, contents-equals), in `evaluator.rs` and [`crates/reportage-core/src/contents_diagnostic.rs`](../../../crates/reportage-core/src/contents_diagnostic.rs).
