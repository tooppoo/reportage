...
[group('check')]
check: examples-shim::go-build examples-shim::rust-build examples-shim::js-install test lint fmt build semantic-docs-check semantic-specs-check semantic-rule-coverage-check ai-docs-check
