...
Migration note: the example-drift check currently reads the copy of this document at [`docs/artifacts.md`](../../docs/artifacts.md). Until that check is repointed at this file, only the [`docs/`](../../docs/) copy is mechanically protected against drift; see [`SHOULD_GENERATE.md`](../SHOULD_GENERATE.md).
...
- [ADR: Artifact Run Result as Canonical Manifest](../../docs/adr/20260708T130500Z_artifact-run-result-canonical-manifest.md)
- [ADR: JSON stdout and Captured Output Artifact Contract](../../docs/adr/20260707T050000Z_json-stdout-and-captured-output-artifact-contract.md)
- [ADR: Separate Execution Report from Output Rendering](../../docs/adr/20260706T001018Z_separate-execution-report-from-output-rendering.md)
