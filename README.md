...
- [Philosophy](docs2/design/philosophy.md): design principles and scope boundaries.
- [Syntax](docs2/reference/syntax.md): normative v0 syntax grammar, generated from `crates/reportage-core/src/reportage.pest`.
- [Semantics](docs2/reference/semantics.md): entry point for the semantics document set, plus language semantic rules such as value literals, expectations, and assertion evaluation.
- [Execution Model](docs2/reference/execution-model.md): runner execution order, case workspace lifecycle, checkpoints, shell execution, and coverage adapter responsibilities.
- [Testing](docs2/design/testing/README.md): how reportage tests itself, self-testing, Rust integration tests, and Rust unit tests, and how to choose between them.
- [Why reportage? / Why not reportage?](docs2/guide/why-reportage.md): When does `reportage` work well, and when does it not?
- [Design Principles](docs2/design/design-principles.md): thin core, transparent shims, opt-in adapters, and evidence-first boundaries.
- [v0 Technical Selection](docs2/design/v0-technical-selection.md): implementation foundation and links to detailed technical specs.
- [Configuration](docs2/reference/configuration.md): KDL v2 config shape, commands, tests, and validation rules.
- [Path Matching](docs2/reference/path-matching.md): path-like config value rules and test glob semantics.
- [Artifacts](docs2/reference/artifacts.md): default artifact generation and early result layout.
- [ADR](docs2/adr/README.md): durable architecture and design decisions.
- [TBD](docs2/planning/TBD.md): intentionally deferred features and design topics.

## v0 Direction

The v0 design is intentionally narrow. Items currently in the grammar ([`docs2/reference/syntax.md`](docs2/reference/syntax.md)):
