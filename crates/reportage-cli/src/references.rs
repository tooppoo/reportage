...
//!
//! [`DOCUMENTS`] doubles as the source for `docs2/ai/reading-order.generated.md`
...
//! reading-order definition. See docs2/adr/20260709T090000Z_ai-documentation-guide-structure.md.
...
pub struct DocumentEntry {
    ...
    /// Internal-only: rendered into `docs2/ai/reading-order.generated.md`, never into `reportage references --format=json` (see the module-level comment and issue #142).
    pub role: &'static str,
...
pub const DOCUMENTS: &[DocumentEntry] = &[
    ...
    DocumentEntry {
        ...
        path: "docs2/ai/quick-reference.md",
    ...
    DocumentEntry {
        ...
        path: "docs2/reference/syntax.md",
    ...
    DocumentEntry {
        ...
        path: "docs2/design/testing/syntax-conformance.md",
    ...
    DocumentEntry {
        id: "semantics",
        title: "Semantics",
        path: "docs2/reference/semantics.md",
    ...
    DocumentEntry {
        ...
        path: "docs2/reference/semantic-rules.md",
    ...
    DocumentEntry {
        id: "diagnostics",
        title: "Diagnostics",
        path: "docs2/reference/diagnostics.md",
    ...
    DocumentEntry {
        ...
        path: "docs2/reference/semantic-diagnostics.md",
    ...
    DocumentEntry {
        ...
        path: "docs2/reference/execution-model.md",
    ...
    DocumentEntry {
        id: "exit-codes",
        title: "Exit codes",
        path: "docs2/reference/exit-codes.md",
    ...
    DocumentEntry {
        id: "configuration",
        title: "Configuration",
        path: "docs2/reference/configuration.md",
    ...
    DocumentEntry {
        id: "artifacts",
        title: "Artifacts",
        path: "docs2/reference/artifacts.md",
    ...
    DocumentEntry {
        ...
        path: "docs2/ai/generation-rules.md",
    ...
    DocumentEntry {
        ...
        path: "docs2/ai/validation-flow.md",
    ...
    DocumentEntry {
        ...
        path: "docs2/ai/common-mistakes.md",
