...
///
/// See docs2/reference/semantics.md — Checkpoint.
...
/// docs2/adr/20260707T012055Z_contents-equals-evaluation.md.
#[derive(Debug)]
...
/// relative to `root`. See docs2/reference/semantics.md — Workspace lifecycle.
...
fn evaluate_case(
    ...
    // this function returns. See docs2/reference/semantics.md — Workspace lifecycle.
    ...
    // PATH. See docs2/reference/semantics.md — Command resolution through PATH shims.
        ...
        match step {
            ...
            Step::AssertionBlock(block) => {
                ...
                for expectation in block.expectations() {
                    ...
                    // docs2/adr/20260704T112155Z_subject-first-file-assertion-syntax.md, and
                    // docs2/adr/20260706T000000Z_subject-first-directory-assertion-syntax.md.
                ...
                // See docs2/adr/20260707T012055Z_contents-equals-evaluation.md.
...
/// its own isolated workspace and `bin` directory. See docs2/reference/semantics.md — Execution order and
...
/// See docs2/adr/20260704T112155Z_subject-first-file-assertion-syntax.md and
/// docs2/adr/20260706T000000Z_subject-first-directory-assertion-syntax.md.
...
/// Byte-level substring search, per docs2/reference/semantics.md's raw byte semantics for `stdout contains` /
...
/// See docs2/adr — output text_equals evaluation.
...
///
/// Per docs2/reference/semantic-diagnostics.md, missing / non-regular-file / unreadable / non-UTF-8 content are all "the `contains` precondition is unmet" — a single failure category distinct from "the file exists and is readable, but does not contain the expected substring".
...
/// workspace, exactly like `file` assertion paths. See docs2/reference/semantics.md.
...
/// type. See docs2/reference/semantics.md.
...
mod tests {
    ...
    fn stderr_text_equals_heredoc_compares_identically_to_quoted() {
        ...
        // to the same TextValue before bytes are compared. See docs2/adr — text_equals evaluation.
