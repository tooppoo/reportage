...
//! live in `result::ContentsEqualsComparison::compare`, not here. See docs/reference/semantic-diagnostics.md
...
/// sequence directly. See docs/reference/semantic-diagnostics.md.
