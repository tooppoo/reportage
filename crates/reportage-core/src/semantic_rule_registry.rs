...
pub enum SemanticRuleId {
    ...
    AssertionStdoutTextEquals,
    AssertionStderrTextEquals,
    AssertionDirExists,
...
impl SemanticRuleId {
    ...
    pub const ALL: &'static [SemanticRuleId] = &[
        ...
        Self::AssertionStdoutTextEquals,
        Self::AssertionStderrTextEquals,
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::AssertionStdoutTextEquals => "assertion.stdout.text_equals",
            Self::AssertionStderrTextEquals => "assertion.stderr.text_equals",
...
pub const SEMANTIC_RULE_REGISTRY: &[SemanticRuleEntry] = &[
    ...
    SemanticRuleEntry {
        id: SemanticRuleId::AssertionStdoutTextEquals,
        category: Assertion,
        implementation_status: Implemented,
        spec_required: true,
        conformance_required: true,
        docs_required: true,
        related_syntax_rule: Some("output_text_equals"),
        related_diagnostic_codes: &[RuleOwned(DiagnosticCode::AssertionStdoutTextEqualsMismatch)],
    },
    SemanticRuleEntry {
        id: SemanticRuleId::AssertionStderrTextEquals,
        category: Assertion,
        implementation_status: Implemented,
        spec_required: true,
        conformance_required: true,
        docs_required: true,
        related_syntax_rule: Some("output_text_equals"),
        related_diagnostic_codes: &[RuleOwned(DiagnosticCode::AssertionStderrTextEqualsMismatch)],
    },
    SemanticRuleEntry {
