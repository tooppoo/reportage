...
/// not yet resolved) `exec` targets. See docs2/reference/configuration.md — Commands.
...
pub struct CommandConfig {
    ...
    /// See docs2/reference/configuration.md — Commands.
    pub exec: String,
}
...
/// intended shim. See docs2/reference/configuration.md — Commands.
